                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="panel">
                                    <div class="panel-heading">
                                        ...
                                        <a href="#" style="float:left" onclick="addlow()"><i class="fa fa-plus-square" ></i></a>
                                    ...
                                    <div class="panel-body" id="papa">
                                        <div id="low-1">
                                            ...
                                            <div style="float:left">&nbsp;&nbsp;</div>
                                            <a href="#" style="float:left" onclick="dele(this)" id="d-1"><span class="label label-danger" class="control-label">删除</span></a>
                                            <br>
                                            <br>
                                        </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <button type="button" class="btn btn-danger btn-block">返回</button>
                                    </div>
                                </div>
                                <!-- END LABELS -->
                                <!-- PROGRESS BARS -->
