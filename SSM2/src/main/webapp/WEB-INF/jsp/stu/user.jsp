                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="UserInfo.do?InfoUserId=${InfoUb.userId}"><i class="lnr lnr-user"></i> <span>我的信息</span></a></li>
                    ...
                    <ul class="nav">
                        ...
                        <li>
                            ...
                            <div id="subPages2" class="collapse">
                                <ul class="nav">
                                    <li><a href="UserInfo.do?InfoUserId=${InfoUb.userId}" class="">我的资料</a></li>
                            ...
                            <div class="profile-right">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade in active" id="tab-bottom-left1">
                                    	<form action="updateUserD.do" method="post">
	                                        <table class="table">
	                                            <tr>
	                                                <td>
