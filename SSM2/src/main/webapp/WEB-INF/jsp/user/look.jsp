                    ...
                    <form action="index.html" method="post" class="definewidth m20">
                        <table class="table table-bordered table-hover definewidth m10">
                            ...
                            <tr>
                                ...
                                <td width="40%">无</td>
                                <td width="10%" class="tableleft">
                                    <font color="red">*</font>工作状态</td>
                                <td width="40%">在职</td>
                            </tr>
                            <tr>
                                <td width="10%" class="tableleft">
                                    <font color="red">*</font>邮箱</td>
                                <td width="40%">123@qq.com</td>
                                <td width="10%" class="tableleft">
                                    <font color="red">*</font>QQ</td>
                                <td width="40%">23123564</td>
                            </tr>
                            <tr>
                                <td width="10%" class="tableleft">
                                    <font color="red">*</font>手机号码</td>
                                <td width="40%">13684442345</td>
                                <td width="10%" class="tableleft">
                                    <font color="red">*</font>电话号码</td>
                                <td width="40%">028-85152312</td>
                            </tr>
                            <tr>
                                <td colspan="4">
                                    <center>
